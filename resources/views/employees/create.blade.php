                        ...
                        <div class="row mb-3">
                            ...
                            <div class="card-header">Kompetencje pracownika</div>
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <label for="testingSystems" class="col-md-4 col-form-label text-md-end">{{ __('testingSystems') }}</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                        <label for="reportingSystems" class="col-md-4 col-form-label text-md-end">reportingSystems</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                        <label for="selenium" class="col-md-4 col-form-label text-md-end">selenium</label>
                                        <div class="col-md-6">
                                            <input id="selenium"
                                            type="text"
                                    ...
                                    <div class="row mb-3">
                                        <label for="ide" class="col-md-4 col-form-label text-md-end">{{ __('ide') }}</label>
                                        <div class="col-md-6">
                                            <input id="ide"
                                                   type="text"
                                    ...
                                    <div class="row mb-3">
                                        <label for="programmingLanguages" class="col-md-4 col-form-label text-md-end">{{ __('programmingLanguages') }}</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                        <label for="mysql" class="col-md-4 col-form-label text-md-end">{{ __('mysql') }}</label>
                                        <div class="col-md-6">
                                        <input id="mysql"
                                               type="text"
                                    ...
                                    <div class="row mb-3">
                                        <label for="projectManagementMethodologies" class="col-md-4 col-form-label text-md-end">{{ __('projectManagementMethodologies') }}</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">
                                        <label for="scrum" class="col-md-4 col-form-label text-md-end">{{ __('scrum') }}</label>
                                        <div class="col-md-6">
